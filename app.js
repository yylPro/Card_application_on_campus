...
function setService(title, kind) {
  ...
  document.getElementById('deliveryContactFields').hidden = !isNumberOrder;
  serviceForm.elements.deliveryRecipient.disabled = !isNumberOrder;
  serviceForm.elements.deliveryRecipient.required = isNumberOrder;
  serviceForm.elements.deliveryPhone.disabled = !isNumberOrder;
  serviceForm.elements.deliveryPhone.required = isNumberOrder;
